...
export default function BookListItem({ book }: IProps) {
    return <li className="mb-10 flex items-center overflow-hidden">
        <img
            className="h-[300px] w-[220px] object-cover mr-2"
            alt={book.title}
        ...
        <div className="p-2">
            ...
            <Link href={`/book/${book.id}`}>
                <button className="border border-black rounded-md px-2 py-1 hover:bg-orange-900 hover:text-white">
                    Read
                </button>
            </Link>
